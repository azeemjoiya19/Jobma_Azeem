...
public class PositionsPage extends TestBase{
	...
	public void createJob() throws InterruptedException
	{
		...
		createbtn.click();
		//System.out.println("Clicked on Positions");
	
		//WebElement wait = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\\\"assessment_kit32588\\\"]")));
		//WebDriverUtilities.wait("//*[@id=\"assessment_kit32588\"]");
		Thread.sleep(5000);
